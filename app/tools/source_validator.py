...
OFFICIAL_PATH_HINTS = {
    "developer", "developers", "docs", "api", "platform", "support", "help", "reference"
}
...
def validate_source(
    ...
    """Validate reachability and authority signals without pretending they prove a claim."""
    ...
    try:
        response = requests.get(
            ...
            timeout=timeout,
            stream=True,
            headers={"User-Agent": "AI-Product-Ops-Research-Agent/1.0"},
        )
